        ...
        <div className="hidden flex-col gap-10 pr-12 lg:flex">
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm text-ink/60">
              Проект создан как сценография для мультибанковских потоков: подключайте API, переключайтесь в ГОСТ-режим,
              оперируйте разнородными продуктами в единой эстетике. Вдохновено инженерными этюдами из{' '}
              <a
                href="https://github.com/anthropics/claude-cookbooks/tree/main/coding"
                target="_blank"
              ...
              , чтобы UI оставался смелым и выразительным.
            </p>
          </div>
