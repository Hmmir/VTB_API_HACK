...
3. **Execute plan workflow**: Follow the structure in IMPL_PLAN template to:
   ...
   - Phase 1: Update agent context by running `.specify/scripts/powershell/update-agent-context.ps1 -AgentType cursor`
...
**Output**: data-model.md, /contracts/*, quickstart.md, .cursor/rules/specify-rules.md
